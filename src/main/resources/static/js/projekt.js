$(document).ready(function(){
	...
	$("#projektModositasForm").submit(function(e){
		...
		$("#igenBiztos").click(function(){
			Modositas({id: $("#hiddenId").val(), nev: $("#ModProNev").val(), ptipus: $("#ModProTipus").val(), status: $("#ModProStatus").val(), oraber: $("#ModProOraber").val(), leiras: $("#ModProLeiras").val(), tipus: "projekt"});
			biztosModal.hide();
			modositasModal.hide();
			location.reload();
		});
	...
	$("#koltsegForm").submit(function(e){
		...
		Feltoltes({proid: $("#projekt").val(), megnevezes: $("#megnevezes").val(), koltseg: $("#koltseg").val(), tipus: "koltseg"});
	...
	$("#koltsegModositasForm").submit(function(e){
		...
		biztosModal.toggle();
		$("#igenBiztos").click(function(){
			Modositas({id: $("#hiddenKoltsegId").val(), proid: $("#ModKoltsegProjekt").val(), megnevezes: $("#ModKoltsegMegnevezes").val(), koltseg: $("#ModKoltsegKoltseg").val(), tipus: "koltseg"});
			biztosModal.hide();
			modositasModal.hide();
			location.reload();
		});
