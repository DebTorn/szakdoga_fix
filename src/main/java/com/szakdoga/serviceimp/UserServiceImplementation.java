...
import com.szakdoga.entity.TokenGenerator;
import com.szakdoga.entity.Ugyfel;
import com.szakdoga.entity.User;
import com.szakdoga.repository.RoleRepository;
import com.szakdoga.repository.UserRepository;
import com.szakdoga.service.UserService;
...
public class UserServiceImplementation implements UserService, UserDetailsService {
	...
	public boolean save(Map<String, String> userRequestDatas) {
		...
		user.setMasodlagosEmail(userRequestDatas.get("masodlagosEmail"));
